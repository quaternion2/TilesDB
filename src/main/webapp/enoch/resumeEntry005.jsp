...
<html>
    <head>
        ...
        <body>
            ...
            <span class ="label"><b>Last Name: </b></span><span class="field"><input type="text" id="lastName" /></span><br>
            <span class ="label"><b>Street Address: </b></span><span class="field"><input type="text" id="streetAddress" /></span><br>
            <span class ="label"><b>City: </b></span><span class="field"><input type="text" id="city" /></span>
            <span class ="label"><b>Province: </b><input type="text" id="province" /></span>
            <b>Postal Code: </b><input type="text" id="postalCode" /><br>
