...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script src="<s:url value="/script/jquery-ui-1.8.24.custom/js/jquery-ui-1.8.24.custom.min.js"/>"></script>
        <link href ="<s:url value="/script/jquery-ui-1.8.24.custom/css/ui-lightness/jquery-ui-1.8.24.custom.css"/>" rel="stylesheet" type="text/css"/>
