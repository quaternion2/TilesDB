...
<script>
    ...
    The state is maintained in the buttons html node. --%>
            ...
            //This should be availible to ALL UI
            /*** TODO: Deffer this functionality until Angular JS
            var toggleFieldVisibility = function() {
                ...
                $(inputs).each(function(i, elem) {
                    ...
                    var titleElem = $("<span>").attr({"class": "input_title"}).html(title);
                    var titleContainer = $("<div>");

                    var inputWrapper = $("<div>");
                    var wrappedInput = $(elem).wrap(inputWrapper);
                    var result = $(wrappedInput).wrap(titleContainer);
                    $(result).before(titleElem);
                });
            };

            $(".toggle_fields").click(toggleFieldVisibility);
            ***/
        });
</script>
<!-- Hidden UI Component-->
...
<ul>
    <li>graphic for del</li>
    <li>graphics for save and saved</li>
    <li>Ordinal will (always be in order!)</li>
    ...
    <li>see if label can be a drop down</li>
</ul>
<div class="framed inline-block">
    <form id="entityDetails"> 
        <fieldset>
            <legend><span class="toggle_fields">Show Fields</span></legend>
